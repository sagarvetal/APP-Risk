...
/**
 * This class is used check whether the attacking and defending countries are adjacent to each other or not
 *
 * @author Akhila Chilukuri
 * @version 1.0.0
 */
public class PreAttackAdjacentCountryTest {
     ...
     */
    @Test
    public void attackPhaseAdjacentTest() {
